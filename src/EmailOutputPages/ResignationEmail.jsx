...
const ResignationEmail = () => {
    ...
    return (
        <div className='flex flex-col border-2 border-red-800 shadow-lg text-black m-5 p-5 rounded-lg'>
            ...
            <p className='text-xl font-medium'>
                Dear {managerName},
                <br /><br />
                Please accept this message as formal notice that I am resigning from the position of <span className='italic'>{designation}</span> with the <span className='italic'>{companyName}</span> company <span className='font-bold'>effecctive from <Moment format='YYYY/MM/DD'>{resignationDate}</Moment></span>.
                <br /><br />
                ...
                <br /><br />
                I wish you and the company the very best going forward. If you need anything please don't hesitate to reach me at {nonWorkEmail}.
                <br /><br />
            </p>
